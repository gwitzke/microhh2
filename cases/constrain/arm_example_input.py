...
#dz for values from surface to 3000m
dz = zsize/ kmax

#dz is then stretched from 3km to 5km
dz_stretched = dz* 1.02
...
# Save all the input data to NetCDFp
...
nc_v   = nc_groups_init.createVariable("v" , float_type, ("z"))
nc_vg  = nc_groups_init.createVariable("vg", float_type, ("z"))
...
nc_sst      = nc_group_timedep.createVariable("sst"     , float_type, ("Sea_time_surface"))
